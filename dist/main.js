...
// $.fn.get_pypi = function (name, node_id, one_or_two) {
//     if (one_or_two === true) {
...
//                       </p>
//                     <a href="${data.info.homepage}" class="stretched-link">Project Page</a>
//                 </div>
//             </div>
//         </div>`,
//                 className: ''
...
//         >
//             <div class="col p-4 d-flex flex-column position-static">
//                 <strong class="d-inline-block mb-2 text-success">${data.info.author}</strong>
